...
class ProductGateway
{
    ...
    {
        $sql = "INSERT INTO product (name, description, size, is_available) VALUES (:name, :description, :size, :is_available)";
    ...
    {
        $sql = "UPDATE product SET name = :name, description = :description, size = :size, is_available = :is_available WHERE id = :id";
